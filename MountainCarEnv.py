...
class Continuous_MountainCarEnv(gym.Env):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self, duration=100, render_mode: Optional[str] = None, goal_velocity=0, const_reward=False):
        ...
        self.max_speed = 0.07
        self.goal_position = (
            0.5  # was 0.5 in gym, 0.45 in Arnaud de Broissia's version
        )
    ...
    def _height(self, xs):
        return 0.4 * np.ones_like(xs) #np.sin(3 * xs) * 0.45 + 0.55
